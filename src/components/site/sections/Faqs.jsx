...
import GlobalFaqs from "@/components/ui/site/GlobalFaqs";
...
export default function Faqs() {
  ...
  return (
    <section>
      ...
      >
        <div className="text-center pb-2 md:pb-12">
          <h2>
            Frequently asked 
            <span className="text-[var(--navigation-color)] px-2">questions</span>
          </h2>
        </div>
